...
int main() {
  ...
  std::cout << "  range: " << parse.to_string() << " slave(1,2) = '"
            << ebus::Ebus::to_string(parse.getSlave().range(1, 2)) << "'"
            << std::endl
            << std::endl;
  ...
  std::cout << "  range: " << parse2.to_string() << " slave(1,2) = '"
            << ebus::Ebus::to_string(parse2.getSlave().range(1, 2)) << "'"
            << std::endl
            << std::endl;

  // create telegram
  ebus::Telegram tel;
  tel.createMaster(uint8_t(0xff), ebus::Ebus::to_vector("52b509030d0600"));
  ...
  // NAK from slave
  seq.assign(ebus::Ebus::to_vector(
  ...
  seq.assign(
      ebus::Ebus::to_vector("ff52b509030d060043ffff52b509030d0600430003b0fba901"
                            "d0ff0003b0fba901d000"));
  ...
  // extend
  seq.assign(ebus::Ebus::to_vector("08b509030da900"), false);
  ...
  seq.assign(ebus::Ebus::to_vector("08b509030daa00"), false);
