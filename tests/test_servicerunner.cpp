...
std::vector<TestCase> test_cases = {
    {true, 0x33, "passive MS: Normal", "ff52b509030d0600430003b0fba901d000"},
    {true, 0x33, "passive MS: Master defect/NAK", "ff52b509030d060044ffff52b509030d0600430003b0fba901d000"},
    {true, 0x33, "passive MS: Master NAK/repeat", "ff52b509030d060043ffff52b509030d0600430003b0fba901d000"},
    {true, 0x33, "passive MS: Master NAK/repeat/NAK", "ff52b509030d060043ffff52b509030d060043ffff52b509030d060043ff"},
    {true, 0x33, "passive MS: Slave defect/NAK/repeat", "ff52b509030d060044ffff52b509030d0600430003b0fba901d000"},
    {true, 0x33, "passive MS: Slave NAK/repeat/NAK", "ff52b509030d0600430003b0fba901d0ff03b0fba901d0ff"},
    {true, 0x33, "passive MS: Master NAK/repeat - Slave NAK/repeat", "ff52b509030d060043ffff52b509030d0600430003b0fba901d0ff03b0fba901d000"},
    {true, 0x33, "passive MS: Master NAK/repeat/ACK - Slave NAK/repeat/NAK", "ff52b509030d060043ffff52b509030d0600430003b0fba901d0ff03b0fba901d0ff"},
    {true, 0x33, "passive MM: Normal", "1000b5050427002400d900"},
    {true, 0x33, "passive BC: defect", "00fe0704003c"},
    {true, 0x33, "passive 00: reset", "00"},
    {true, 0x33, "passive 0704: scan", "002e0704004e"},
    {true, 0x33, "passive BC: normal", "10fe07000970160443183105052592"},
    {true, 0x33, "passive MS: slave CRC byte is invalid", "1008b5130304cd017f000acd01000000000100010000"},

    {true, 0x33, "reactive MS: Slave NAK/ACK", "0038070400ab000ab5504d5330300107430246ff0ab5504d533030010743024600"},
    {true, 0x33, "reactive MS: Slave NAK/NAK", "0038070400ab000ab5504d5330300107430246ff0ab5504d5330300107430246ff"},
    {true, 0x33, "reactive MS: Master defect/correct", "0038070400acff0038070400ab000ab5504d533030010743024600"},
    {true, 0x33, "reactive MS: Master defect/defect", "0038070400acff0038070400acff"},
    {true, 0x33, "reactive MS: Slave defect (callback)", "003807050030aa"},
    {true, 0x33, "reactive MM: Normal", "003307040014"},
    {true, 0x33, "reactive BC: Normal", "00fe0704003b"},

    {true, 0x33, "active BC: Request Bus - Normal", "33feb5050427002d00", "feb5050427002d00"},
    {true, 0x33, "active BC: Request Bus - Priority lost", "01feb5050427002d007b", "feb5050427002d00"},
    {true, 0x33, "active BC: Request Bus - Priority lost/wrong byte", "01ab", "feb5050427002d00"},
    {true, 0x33, "active BC: Request Bus - Priority fit/won", "73aa33feb5050427002d00", "feb5050427002d00"},
    {true, 0x33, "active BC: Request Bus - Priority fit/lost", "73aa13", "feb5050427002d00"},
    {true, 0x33, "active BC: Request Bus - Priority retry/error", "73a0", "feb5050427002d00"},
    {true, 0x33, "active MS: Normal", "3352b509030d46003600013fa4", "52b509030d4600"},
    {true, 0x33, "active MS: Master NAK/ACK - Slave CRC wrong/correct", "3352b509030d460036ff3352b509030d46003600013fa3ff013fa4", "52b509030d4600"},
    {true, 0x33, "active MS: Master NAK/ACK - Slave CRC wrong/wrong", "3352b509030d460036ff3352b509030d46003600013fa3ff013fa3ff", "52b509030d4600"},
    {true, 0x33, "active MS: Master NAK/NAK", "3352b509030d460036ff3352b509030d460036ff", "52b509030d4600"},
    {true, 0x33, "active MM: Master NAK/ACK", "3310b57900fbff3310b57900fb00", "10b57900"},
    {true, 0x30, "active BC: Request Bus - Priority lost and Sub lost", "1052b50401314b000200002c00", "feb5050427002d00"},
