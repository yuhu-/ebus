...
bool MultiForward::append(const string& ip, long port, const string& filter, ostringstream& result)
{
...
bool MultiForward::remove(const string& ip, long port, const string& filter, ostringstream& result)
{
